...
const { detectIndent } = require('../util/indent')
 ...
 * @property {string} where[].property - property key path
 * @property {string} where[].isEqualTo - comparison string
 */
...
async function mergeJSON(into, from, project, semantics) {
    ...
    if (typeof into === 'string') {
        ...
        await write(into, JSON.stringify(result, null, indent ?? 2))
    }
    return result
}
