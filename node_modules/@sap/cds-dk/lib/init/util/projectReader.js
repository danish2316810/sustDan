...
module.exports = new class ProjectReader {
    ...
    constructor() {
        ...
        if (exists('pom.xml')) {
            ...
            if (v) {
                // check compliance with mta version format - copied from mbt error message
                if (/^(0|[1-9]\d*)\.(0|[1-9]\d*)\.(0|[1-9]\d*)(-(0|[1-9]\d*|\d*[a-zA-Z-][0-9a-zA-Z-]*)(\.(0|[1-9]\d*|\d*[a-zA-Z-][0-9a-zA-Z-]*))*)?(\+[0-9a-zA-Z-]+(\.[0-9a-zA-Z-]+)*)?$/.test(v)) {
                    this.appVersion = v
                }
            }
